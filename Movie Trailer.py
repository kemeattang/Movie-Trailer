      ...
      <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
            <a class="navbar-brand" href="#"> KEM Movie trailers Movie Trailers</a>
          </div>
        </div>
      </div>
    </div>
...
def open_movies_page(movies):
    ...
    output_file = open('geebaba.html', 'w')
